...
const stats = [
  { label: "Æfingar í viku", value: "3x", icon: Calendar },
  { label: "Mót á tímabilinu", value: "6+", icon: Trophy },
  { label: "Félagsandi + hreyfing", value: "✓", icon: Heart },
];
...
const packages = [
  {
    ...
    features: [
      "1x æfing í viku",
      "Grunnatriði Fortnite",
      "Hópstarf og félagsskapur",
      "Aðgang að Discord",
    ],
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <img 
              src={geimurLogo} 
              alt="Geimur" 
              className="h-32 md:h-40 lg:h-48 w-auto mx-auto mb-8 animate-float"
            />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {stats.map((stat, index) => (
                <Card key={index} className="bg-card/50 border-border card-hover backdrop-blur-sm">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {packages.map((pkg, index) => (
              <Card 
                key={index} 
                className={`bg-card border-border card-hover relative ${
                  pkg.featured ? 'border-primary glow-red-sm' : ''
                }`}
              >
                {pkg.featured && (
